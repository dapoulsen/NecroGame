...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input Actions/PlayerControl.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlayerControl: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerControl()
    {
        UnityEngine.Debug.Assert(!m_Ground.enabled, "This will cause a leak and performance issues, PlayerControl.Ground.Disable() has not been called.");
    }
